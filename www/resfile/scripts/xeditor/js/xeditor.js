...
(function (factory) {
    //IMG MENU 5582, upload_url 5719
    //BUTTON MENU 3158
    if (typeof window.define === 'function') {
        if (window.define.amd) {
            // AMD模式
            window.define('xeditor', ["jquery"], factory);
        ...
        // 引用 css —— webapck
        window.xeditorCssPath ? require(window.xeditorCssPath) : require('../css/xeditor.css');
        module.exports = factory(
            // 传入 jquery ，支持使用 npm 方式或者自己定义jquery的路径
            window.xeditorJQueryPath ? require(window.xeditorJQueryPath) : require('jquery')
        );
    } else {
        // 全局模式
        factory(window.jQuery);
...
// 定义构造函数
    (function (window, $) {
        ...
        // 用户在引用 x.js 之后，还可以通过 E.plugin() 注入自定义函数，
...
// MenuContainer.fn bind fn
    _e(function (E, $) {
        ...
        MenuContainer.fn.init = function () {
            ...
            var $menuContainer = $('<div class="x-menu-container clearfix"></div>');
        ...
        MenuContainer.fn.changeShadow = function () {
            ...
            $txt.on('scroll', function () {
                if ($txt.scrollTop() > 10) {
                    $menuContainer.addClass('x-menu-shadow');
                } else {
                    $menuContainer.removeClass('x-menu-shadow');
                }
            });
        };
    ...
    _e(function (E, $) {
        ...
        MenuContainer.fn._addGroup = function (groupIdx) {
            ...
            if (!this.$currentGroup || this.currentGroupIdx !== groupIdx) {
                ...
                if (groupIdx != 0) {
                    $menuGroup = $('<div style="float:left"><span class="menu-fg"></span></div>');
                    $menuContainer.append($menuGroup);
                }
                this.$currentGroup = $menuContainer;
...
// dropList fn bind
    _e(function (E, $) {
        ...
        DropList.fn.initDOM = function () {
            ...
            var $list = $('<div class="x-drop-list clearfix"></div>');
...
// dropPanel fn bind
    _e(function (E, $) {
        ...
        DropPanel.fn.initDOM = function () {
            ...
            var $panel = $('<div class="x-drop-panel clearfix"></div>');
...
// modal fn bind
    _e(function (E, $) {
        ...
        Modal.fn.initDom = function () {
            var self = this;
            var $content = self.$content;
            var $modal = $('<div class="x-modal"></div>');
            var $close = $('<div class="x-modal-close"><i class="x-menu-img-cancel-circle"></i></div>');
    ...
    _e(function (E, $) {
        ...
        Txt.fn.init = function () {
            ...
            if ($valueContainer.get(0).nodeName === 'DIV') {
                ...
                $txt = $(
                    '<div class="x-txt" contentEditable="true">' +
                    currentValue +
                    '</div>'
                );
            }
...
// 全局配置
    _e(function (E, $) {
        ...
        //AJAX 上传 URL
        E.config.ajaxuploadurl = '/handle/post_upload.php';
        ...
        E.config.emotions = {
            'default': {
                ...
                data: [
                    {
                        icon: '/apps/xeditor/emotions/default/1.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/2.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/3.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/4.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/5.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/6.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/7.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/8.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/9.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/10.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/11.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/12.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/13.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/14.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/15.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/16.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/17.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/18.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/19.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/20.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/21.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/22.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/23.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/24.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/25.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/26.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/27.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/28.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/29.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/30.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/31.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/32.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/33.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/34.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/35.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/36.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/37.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/38.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/39.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/40.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/41.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/42.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/43.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/44.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/45.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/46.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/47.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/48.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/49.gif',
                        value: ''
                    },
                    {
                        icon: '/apps/xeditor/emotions/default/50.gif',
                        value: ''
                    },
                ]
            }
...
// 全局UI
    _e(function (E, $) {
        ...
        E.UI.menus = {
            ...
            'default': {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-asterisk"></i></a>',
                selected: '.selected'
            },
            bold: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-bold"></i></a>',
                selected: '.selected'
            },
            underline: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-underline"></i></a>',
                selected: '.selected'
            },
            italic: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-italic"></i></a>',
                selected: '.selected'
            },
            forecolor: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-pencil"></i></a>',
                selected: '.selected'
            },
            bgcolor: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-paint-brush"></i></a>',
                selected: '.selected'
            },
            strikethrough: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-strikethrough"></i></a>',
                selected: '.selected'
            },
            eraser: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-eraser"></i></a>',
                selected: '.selected'
            },
            quote: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-quote-left"></i></a>',
                selected: '.selected'
            },
            //源代码按钮
            /*source: {
             normal: '<a href="#" tabindex="-1"><i class="fa fa-code"></i></a>',
             selected: '.selected'
             },*/
            fontfamily: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-font"></i></a>',
                selected: '.selected'
            },
            fontsize: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-text-height"></i></a>',
                selected: '.selected'
            },
            title: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-header"></i></a>',
                selected: '.selected'
            },
            orderlist: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-list-ol"></i></a>',
                selected: '.selected'
            },
            unorderlist: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-list-ul"></i></a>',
                selected: '.selected'
            },
            alignleft: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-align-left"></i></a>',
                selected: '.selected'
            },
            aligncenter: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-align-center"></i></a>',
                selected: '.selected'
            },
            alignright: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-align-right"></i></a>',
                selected: '.selected'
            },
            link: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-link"></i></a>',
                selected: '.selected'
            },
            unlink: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-unlink"></i></a>',
                selected: '.selected'
            },
            table: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-table"></i></a>',
                selected: '.selected'
            },
            emotion: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-smile-o"></i></a>',
                selected: '.selected'
            },
            img: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-image"></i></a>',
                selected: '.selected'
            },
            video: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-play"></i></a>',
                selected: '.selected'
            },
            location: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-map-marker"></i></a>',
                selected: '.selected'
            },
            insertcode: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-terminal"></i></a>',
                selected: '.selected'
            },
            undo: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-undo"></i></a>',
                selected: '.selected'
            },
            redo: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-repeat"></i></a>',
                selected: '.selected'
            },
            money: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-gg"></i></a>',
                selected: '.selected'
            },
            unmoney: {
                normal: '<a href="#" tabindex="-1"><i class="fa fa-gg"></i><i class="fa fa-close"></i></a>',
                selected: '.selected'
            }
            //全屏按钮
            /* fullscreen: {
             normal: '<a href="#" tabindex="-1"><i class="fa fa-enlarge2"></i></a>',
             selected: '<a href="#" tabindex="-1" class="selected"><i class="fa fa-shrink2"></i></a>'
             }*/
        };
...
// 增加 container
    _e(function (E, $) {
        ...
        E.fn.addEditorContainer = function () {
            this.$editorContainer = $('<div class="xeditor"></div>');
        };
            ...
            $.each(configColors, function (k, v) {
                $content.append(
                    [
                        '<a href="#" class="color-item"',
                        '    title="' + v + '" commandValue="' + k + '" ',
                        '    style="color: ' + k + '" style="width:100%;height:100%"',
                        '><i class="fa fa-square"></i></a>'
                    ].join('')
                );
            });
    ...
    _e(function (E, $) {
        E.createMenu(function (check) {
            ...
            menu.dropList = new E.DropList(editor, menu, {
                data: data,
                tpl: tpl,
                // 对 ol 直接设置 title，会出现每个 li 的 index 都变成 1 的问题，因此要先取消 ol，然后设置 title，最后再增加上 ol
...
// money 菜单
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            //创建 dropPanel
            var $content = $('<div></div>');
            var $textInput = $('<input type="text" class="block" placeholder="金币数量"/>');
            var $btnSubmit = $('<button class="right">' + lang.submit + '</button>');
            var $btnCancel = $('<button class="right gray">' + lang.cancel + '</button>');
            $content.append($textInput).append($btnSubmit).append($btnCancel);
            ...
            menu.clickEvent = function () {
                ...
                var linkbox = $(".x-txt").find("money");
                if (linkbox.length > 0) {
                    return;
                }

                var tonull = editor.isRangeEmpty();
                if (!tonull) {
                    //选区不是空
                    if (dropPanel.isShowing) {
                        dropPanel.hide();
            ...
            $btnSubmit.click(function (e) {
                ...
                if (!isRangeEmpty) {
                    // 选区不是空
                    text = editor.getRangeElem();
                    var targetElem = editor.getSelfOrParentByName(text, 'a');
                    if (targetElem) {
                        text = $(text).parent().html();
                        text = text.replace('<br>', '');
                    } else {
                        text = editor.getRangeText();
                    }

                    var linkhtml = '<money><span class="money-conent">' + text + '</span><span class="span-money">' + $textInput.val() + '</span></money>';
                    editor.command(e, 'insertHtml', linkhtml);
                } else if (rangeElem) {
                    return;
                }
            ...
            $txt.on('keydown', function (e) {
                ...
                var rangeElem = editor.getRangeElem();
                var targetElem = editor.getSelfOrParentByName(rangeElem, 'money');
                if (targetElem) {
                    e.preventDefault();
                }
            });
            ...
            menu.updateSelectedEvent = function () {
                var rangeElem = editor.getRangeElem();
                rangeElem = editor.getSelfOrParentByName(rangeElem, 'money');
                if (rangeElem) {
                    editor.enableMenusExcept();
                    editor.disableMenusExcept('unmoney');
                    var menu2 = editor.menus['unmoney'];
                    menu2.changeSelectedState(true);
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            $.each(configEmotions, function (k, emotion) {
                ...
                // 增加该组表情的tab和content
                var $tab = $('<a href="#"><i class="fa fa-caret-right"></i> ' + title + ' </a>');
...
// img 菜单
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            // tab
            var $uploadTab = $('<a href="#" class="selected"><i class="fa fa-caret-right"></i> 上传文件</a>');
            var $linkTab = $('<a href="#" class="hidden"><i class="fa fa-caret-right"></i> 网络图片</a>');
            $tabContainer.append($uploadTab).append($linkTab);

            // 上传图片 content
            var $uploadContent = $('<div class="selected"></div>');
            ...
            //上传图片panel处理
            var temp_id = 0;
            var $uploadlistbox = $('<div></div>');
            var $uploadbtnbox = $('<div style="display: flex; flex-wrap: nowrap; flex-flow: row; justify-content: space-between;"></div>');
            var $uploadfilebtn = $('<input class="hidden" id="file-total" type="file" name="file" accept="image/jpeg, image/gif">');
            var $uploadbtnlist = $('<button type="button"><i class="fa fa-folder"></i> 浏览</button>');
            var $uploadbtnclean = $('<button class="right gray" type="button"><i class="fa fa-trash-o"></i> 清空</button>');
            var $uploadbtnfile = $('<button class="right" type="button"><i class="fa fa-upload"></i> 上传</button>');
            var $uploadbtncel = $('<button class="right gray" type="button"><i class="fa fa-power-off"></i> 取消</button>');

            $uploadbtnbox.append($uploadfilebtn).append($uploadbtnlist).append($uploadbtnfile).append($uploadbtncel).append($uploadbtnclean);

            $uploadContent.append($uploadlistbox).append($uploadbtnbox);

            //事件组
            $uploadbtnclean.click(function (e) {
                $uploadlistbox.html('');
            });
            $uploadbtncel.click(function (e) {
                e.preventDefault();
                menu.dropPanel.hide();
            });
            $uploadbtnlist.click(function (e) {
                $("#file-total").click();
            });

            $uploadfilebtn.change(function (e) {
                var files = $(this).prop("files")[0];
                var filetype = files.name.substr(files.name.indexOf('.'));
                var file_num = $uploadlistbox.find("input").length;

                var $filebox = $('<div class="" style="margin: 3px 4px 3px 4px; border: 1px solid #ccc; height: 26px;"></div>');
                //var $fileinput = $('<input type="file" class="hidden" name="file" id="file' + file_num + '">');
                //$fileinput.appendTo($filebox);
                var $filebox_ico = $('<div style="padding: 5px 5px 5px 5px; float:left;"><i class="fa fa-image"></i></div>');
                var $filebox_name = $('<div style="padding: 5px 5px 5px 0px; float:left;">' + files.name.substr(0, 30) + '</div>');
                var $err_msg = $('<div id="err-msg" style="padding: 5px 5px 5px 0; color:#ff0000; float:right;"></div>');
                var $filebox_loginico = $('<div id="icod" style="padding: 5px 5px 5px 0; float:right;"><i id="ico" class="fa fa-refresh fa-spin hidden"></i><i class="hidden fa fa-close font-color-red" id="ico-err"></i><button type="button" id="ico-err-msg" class="hidden" style="padding: 0;margin-left: 3px;background-color: transparent;"><i class="fa fa-commenting-o"></i></button><i id="ico-suc" class="hidden fa fa-check font-color-blue"></i></div>');
                var $filebox_addico = $('<button id="addico" type="button" class="hidden" style="padding: 0;margin-left: 3px;background-color: transparent;"><i class="fa fa-plus" style="color:#1e88e5; "></i></button>');
                var $filebox_removeico = $('<button type="button" class="" id="rembtn" style="padding: 0; background-color: transparent;"><i class="fa fa-close"></i></button>');

                $filebox_loginico.append($filebox_addico).append($filebox_removeico);
                $filebox.append($filebox_ico).append($filebox_name).append($filebox_loginico).append($err_msg);
                $uploadlistbox.append($filebox);

                var oldelement = $(this);
                var newelement = oldelement.clone(true);
                oldelement.before(newelement);
                oldelement.attr("id", "file" + file_num);
                oldelement.appendTo($filebox);

                $filebox_removeico.click(function (e) {
                    var pan = $(this).parent().parent();
                    $(pan).remove();
                    return false;
                });
                return false;
            ...
            //TODO:上传图片 ajax 处理
            $uploadbtnfile.click(function (e) {
                var filedata = $uploadlistbox.find("input");
                filedata.each(function (e) {
                    var pan = $(this).parent();
                    var remico = $(pan).find("#rembtn");
                    var addico = $(pan).find("#addico");
                    var reminput = "#" + this.id;
                    var ico = $(pan).find("#ico");
                    var ico_err = $(pan).find("#ico-err");
                    var ico_suc = $(pan).find("#ico-suc");
                    var ico_err_msg = $(pan).find("#ico-err-msg");
                    var errmsg = $(pan).find("#err-msg");
                    $(remico).addClass("hidden");
                    $(ico).removeClass("hidden");
                    $(pan).find("#icod").removeClass("hidden");
                    var elemid = this.id;
                    var fileinput = this;
                    $.ajaxFileUpload({
                        url: "/home/handles/xeditupload.html?x=" + Math.random(),
                        type: "POST",
                        ...
                        success: function (data) {
                            ...
                            switch (data.t) {
                                case "suc":
                                    $(reminput).addClass("hidden");
                                    $(ico).addClass("hidden");
                                    $(addico).removeClass("hidden");
                                    $(pan).addClass("filebox-success");
                                    $(ico_suc).removeClass("hidden");
                                    $(addico).click(function (e) {
                                        editor.command(e, "insertHTML", "<img src='" + data.m + "'>");
                                    });
                                    editor.command(e, "insertHTML", "<img src='" + data.m + "'>");
                                    break;
                                case "err":
                                    $(reminput).remove();
                                    $(ico).addClass("hidden");
                                    $(pan).addClass("filebox-error");
                                    $(ico_err).removeClass("hidden");
                                    $(ico_err_msg).removeClass("hidden");
                                    $(ico_err_msg).click(function (e) {
                                        var index = layer.tips(data.m, this, {
                                            tips: 4
                                        });
                                    });
...
// video 菜单
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            var $howToCopy = $('<a href="http://www.kancloud.cn/wangfupeng/x2/134973" target="_blank" style="display:inline-block;margin-top:10px;margin-left:10px;color:#999;">如何复制视频链接？</a>');
            var $btnSubmit = $('<button class="right">' + lang.submit + '</button>');
            var $btnCancel = $('<button class="right gray">' + lang.cancel + '</button>');
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            /*function updateMenu() {
             ...
             $txt.on('keydown keyup click', function (e) {
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            menu.clickEvent = function (e) {
                // 增加样式
                var $editorContainer = editor.$editorContainer;
                $editorContainer.addClass('x-fullscreen');
            ...
            menu.clickEventSelected = function (e) {
                // 取消样式
                var $editorContainer = editor.$editorContainer;
                $editorContainer.removeClass('x-fullscreen');
...
// 进度条
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            var $progress = $('<div class="x-upload-progress"></div>');
...
// upload img 插件
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            // 自定义UI，并添加到上传dom节点上
            var $uploadIcon = $('<div class="upload-icon-container"><i class="x-menu-img-upload"></i></div>');
...
// form方式上传图片
    _e(function (E, $) {
        ...
        UploadFile.fn.render = function () {
            var self = this;
            var editor = self.editor;
            var uploadFileName = editor.config.uploadImgFileName || 'xFormFile';
            if (self._hasRender) {
                // 不要重复渲染
                return;
            }
...
// upload img 插件 粘贴图片
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            var config = editor.config;
            var uploadImgUrl = config.uploadImgUrl;
            var uploadFileName = config.uploadImgFileName || 'xPasteFile';
            var pasteEvent;
            var $imgsBeforePaste;
...
// 拖拽上传图片 插件
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            var config = editor.config;
            var uploadImgUrl = config.uploadImgUrl;
            var uploadFileName = config.uploadImgFileName || 'xDragFile';
...
// 编辑器区域 table toolbar
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            var $triangle = $('<div class="tip-triangle"></div>');
            var $delete = $('<a href="#"><i class="fa fa-trash-o"></i></a>');
            var $zoomSmall = $('<a href="#"><i class="fa fa-search-minus"></i></a>');
            var $zoomBig = $('<a href="#"><i class="fa fa-search-plus"></i></a>');
...
// 编辑器区域 img toolbar
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            var $zoomSmall = $('<a href="#"><i class="fa fa-search-minus"></i></a>');
            var $zoomBig = $('<a href="#"><i class="fa fa-search-plus"></i></a>');
            // var $floatLeft = $('<a href="#"><i class="x-menu-img-align-left"></i></a>');
            // var $noFloat = $('<a href="#"><i class="x-menu-img-align-justify"></i></a>');
            // var $floatRight = $('<a href="#"><i class="x-menu-img-align-right"></i></a>');
            var $alignLeft = $('<a href="#"><i class="fa fa-align-left"></i></a>');
            var $alignCenter = $('<a href="#"><i class="fa fa-align-center"></i></a>');
            var $alignRight = $('<a href="#"><i class="fa fa-align-right"></i></a>');
            var $link = $('<a href="#"><i class="fa fa-link"></i></a>');
            var $unLink = $('<a href="#"><i class="fa fa-unlink"></i></a>');
...
// 编辑区域 link toolbar
    _e(function (E, $) {
        E.plugin(function () {
            ...
            var $toolbar = $('<div class="txt-toolbar"></div>');
            var $triangle = $('<div class="tip-triangle"></div>');
            var $triggerLink = $('<a href="#" target="_blank"><i class="x-menu-img-link"></i> ' + lang.openLink + '</a>');
            var isRendered;
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            var menu = new E.Menu({
                ...
                $domNormal: $('<a href="#" tabindex="-1"><i class="x-menu-img-indent-left"></i></a>'),
                $domSelected: $('<a href="#" tabindex="-1" class="selected"><i class="x-menu-img-indent-left"></i></a>')
            });
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            var menu = new E.Menu({
                ...
                // 正常状态和选中装下的dom对象，样式需要自定义
                $domNormal: $('<a href="#" tabindex="-1"><i class="x-menu-img-arrows-v"></i></a>'),
                $domSelected: $('<a href="#" tabindex="-1" class="selected"><i class="x-menu-img-arrows-v"></i></a>')
            });
...
jQuery.extend({
    ...
    ajaxFileUpload: function (s) {
        ...
        s.dataType = s.dataType == null ? "text" : s.dataType;
